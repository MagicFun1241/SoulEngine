...
procedure TDockCaptionDrawer.DrawDockCaption(const Canvas: TCanvas; CaptionRect: TRect; State: TParentFormState);
  ...
  try
    ...
    if CapRect.Bottom>CapRect.Top then begin
      ...
      begin
        ...
        Font := CreateFontIndirectA(FontInfo);

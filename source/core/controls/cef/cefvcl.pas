...
type
  ...
  private
    ...
    FOnChromiumLibLoad: TNotifyEvent;
  ...
  protected
    ...
    property OnChromiumLibLoad: TNotifyEvent read FOnChromiumLibLoad write FOnChromiumLibLoad;
...
begin
  ...
  begin
    ...
    begin
      if Assigned(FOnChromiumLibLoad) then
          FOnChromiumLibLoad( Self );
    end; 

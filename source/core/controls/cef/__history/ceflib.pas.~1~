...
{$ENDIF}
    ChromiumLibHandle := LoadLibrary(PChar(CefLibrary));
    if ChromiumLibHandle = 0 then
      RaiseLastOSError;

    cef_string_wide_set := GetProcAddress(ChromiumLibHandle, 'cef_string_wide_set');
    cef_string_utf8_set := GetProcAddress(ChromiumLibHandle, 'cef_string_utf8_set');
    cef_string_utf16_set := GetProcAddress(ChromiumLibHandle, 'cef_string_utf16_set');
    cef_string_wide_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_wide_clear');
    cef_string_utf8_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_utf8_clear');
    cef_string_utf16_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_utf16_clear');
    cef_string_wide_cmp := GetProcAddress(ChromiumLibHandle, 'cef_string_wide_cmp');
    cef_string_utf8_cmp := GetProcAddress(ChromiumLibHandle, 'cef_string_utf8_cmp');
    cef_string_utf16_cmp := GetProcAddress(ChromiumLibHandle, 'cef_string_utf16_cmp');
    cef_string_wide_to_utf8 := GetProcAddress(ChromiumLibHandle, 'cef_string_wide_to_utf8');
    cef_string_utf8_to_wide := GetProcAddress(ChromiumLibHandle, 'cef_string_utf8_to_wide');
    cef_string_wide_to_utf16 := GetProcAddress(ChromiumLibHandle, 'cef_string_wide_to_utf16');
    cef_string_utf16_to_wide := GetProcAddress(ChromiumLibHandle, 'cef_string_utf16_to_wide');
    cef_string_utf8_to_utf16 := GetProcAddress(ChromiumLibHandle, 'cef_string_utf8_to_utf16');
    cef_string_utf16_to_utf8 := GetProcAddress(ChromiumLibHandle, 'cef_string_utf16_to_utf8');
    cef_string_ascii_to_wide := GetProcAddress(ChromiumLibHandle, 'cef_string_ascii_to_wide');
    cef_string_ascii_to_utf16 := GetProcAddress(ChromiumLibHandle, 'cef_string_ascii_to_utf16');
    cef_string_userfree_wide_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_wide_alloc');
    cef_string_userfree_utf8_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_utf8_alloc');
    cef_string_userfree_utf16_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_utf16_alloc');
    cef_string_userfree_wide_free := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_wide_free');
    cef_string_userfree_utf8_free := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_utf8_free');
    cef_string_userfree_utf16_free := GetProcAddress(ChromiumLibHandle, 'cef_string_userfree_utf16_free');
...
{$ENDIF}
    ...
    cef_string_map_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_map_alloc');
    cef_string_map_size := GetProcAddress(ChromiumLibHandle, 'cef_string_map_size');
    cef_string_map_find := GetProcAddress(ChromiumLibHandle, 'cef_string_map_find');
    cef_string_map_key := GetProcAddress(ChromiumLibHandle, 'cef_string_map_key');
    cef_string_map_value := GetProcAddress(ChromiumLibHandle, 'cef_string_map_value');
    cef_string_map_append := GetProcAddress(ChromiumLibHandle, 'cef_string_map_append');
    cef_string_map_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_map_clear');
    cef_string_map_free := GetProcAddress(ChromiumLibHandle, 'cef_string_map_free');
    cef_string_list_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_list_alloc');
    cef_string_list_size := GetProcAddress(ChromiumLibHandle, 'cef_string_list_size');
    cef_string_list_value := GetProcAddress(ChromiumLibHandle, 'cef_string_list_value');
    cef_string_list_append := GetProcAddress(ChromiumLibHandle, 'cef_string_list_append');
    cef_string_list_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_list_clear');
    cef_string_list_free := GetProcAddress(ChromiumLibHandle, 'cef_string_list_free');
    cef_string_list_copy := GetProcAddress(ChromiumLibHandle, 'cef_string_list_copy');
    cef_initialize := GetProcAddress(ChromiumLibHandle, 'cef_initialize');
    cef_shutdown := GetProcAddress(ChromiumLibHandle, 'cef_shutdown');
    cef_do_message_loop_work := GetProcAddress(ChromiumLibHandle, 'cef_do_message_loop_work');
    cef_run_message_loop := GetProcAddress(ChromiumLibHandle, 'cef_run_message_loop');
    cef_register_extension := GetProcAddress(ChromiumLibHandle, 'cef_register_extension');
    cef_register_custom_scheme := GetProcAddress(ChromiumLibHandle, 'cef_register_custom_scheme');
    cef_register_scheme_handler_factory := GetProcAddress(ChromiumLibHandle, 'cef_register_scheme_handler_factory');
    cef_clear_scheme_handler_factories := GetProcAddress(ChromiumLibHandle, 'cef_clear_scheme_handler_factories');
    cef_add_cross_origin_whitelist_entry := GetProcAddress(ChromiumLibHandle, 'cef_add_cross_origin_whitelist_entry');
    cef_remove_cross_origin_whitelist_entry := GetProcAddress(ChromiumLibHandle, 'cef_remove_cross_origin_whitelist_entry');
    cef_clear_cross_origin_whitelist := GetProcAddress(ChromiumLibHandle, 'cef_clear_cross_origin_whitelist');
    cef_currently_on := GetProcAddress(ChromiumLibHandle, 'cef_currently_on');
    cef_post_task := GetProcAddress(ChromiumLibHandle, 'cef_post_task');
    cef_post_delayed_task := GetProcAddress(ChromiumLibHandle, 'cef_post_delayed_task');
    cef_parse_url := GetProcAddress(ChromiumLibHandle, 'cef_parse_url');
    cef_create_url := GetProcAddress(ChromiumLibHandle, 'cef_create_url');
    cef_visit_all_cookies := GetProcAddress(ChromiumLibHandle, 'cef_visit_all_cookies');
    cef_visit_url_cookies := GetProcAddress(ChromiumLibHandle, 'cef_visit_url_cookies');
    cef_set_cookie := GetProcAddress(ChromiumLibHandle, 'cef_set_cookie');
    cef_delete_cookies := GetProcAddress(ChromiumLibHandle, 'cef_delete_cookies');
    cef_set_cookie_path := GetProcAddress(ChromiumLibHandle, 'cef_set_cookie_path');
    cef_visit_storage := GetProcAddress(ChromiumLibHandle, 'cef_visit_storage');
    cef_set_storage := GetProcAddress(ChromiumLibHandle, 'cef_set_storage');
    cef_delete_storage := GetProcAddress(ChromiumLibHandle, 'cef_delete_storage');
    cef_set_storage_path := GetProcAddress(ChromiumLibHandle, 'cef_set_storage_path');
    cef_browser_create := GetProcAddress(ChromiumLibHandle, 'cef_browser_create');
    cef_browser_create_sync := GetProcAddress(ChromiumLibHandle, 'cef_browser_create_sync');
    cef_request_create := GetProcAddress(ChromiumLibHandle, 'cef_request_create');
    cef_post_data_create := GetProcAddress(ChromiumLibHandle, 'cef_post_data_create');
    cef_post_data_element_create := GetProcAddress(ChromiumLibHandle, 'cef_post_data_element_create');
    cef_stream_reader_create_for_file := GetProcAddress(ChromiumLibHandle, 'cef_stream_reader_create_for_file');
    cef_stream_reader_create_for_data := GetProcAddress(ChromiumLibHandle, 'cef_stream_reader_create_for_data');
    cef_stream_reader_create_for_handler := GetProcAddress(ChromiumLibHandle, 'cef_stream_reader_create_for_handler');
    cef_stream_writer_create_for_file := GetProcAddress(ChromiumLibHandle, 'cef_stream_writer_create_for_file');
    cef_stream_writer_create_for_handler := GetProcAddress(ChromiumLibHandle, 'cef_stream_writer_create_for_handler');
    cef_v8context_get_current_context := GetProcAddress(ChromiumLibHandle, 'cef_v8context_get_current_context');
    cef_v8context_get_entered_context := GetProcAddress(ChromiumLibHandle, 'cef_v8context_get_entered_context');
    cef_v8value_create_undefined := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_undefined');
    cef_v8value_create_null := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_null');
    cef_v8value_create_bool := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_bool');
    cef_v8value_create_int := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_int');
    cef_v8value_create_double := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_double');
    cef_v8value_create_date := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_date');
    cef_v8value_create_string := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_string');
    cef_v8value_create_object := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_object');
    cef_v8value_create_object_with_accessor := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_object_with_accessor');
    cef_v8value_create_array := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_array');
    cef_v8value_create_function := GetProcAddress(ChromiumLibHandle, 'cef_v8value_create_function');
    cef_web_urlrequest_create := GetProcAddress(ChromiumLibHandle, 'cef_web_urlrequest_create');
    cef_xml_reader_create := GetProcAddress(ChromiumLibHandle, 'cef_xml_reader_create');
    cef_zip_reader_create := GetProcAddress(ChromiumLibHandle, 'cef_zip_reader_create');

    cef_string_multimap_alloc := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_alloc');
    cef_string_multimap_size := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_size');
    cef_string_multimap_find_count := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_find_count');
    cef_string_multimap_enumerate := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_enumerate');
    cef_string_multimap_key := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_key');
    cef_string_multimap_value := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_value');
    cef_string_multimap_append := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_append');
    cef_string_multimap_clear := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_clear');
    cef_string_multimap_free := GetProcAddress(ChromiumLibHandle, 'cef_string_multimap_free');
